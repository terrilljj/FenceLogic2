...
## Product Categories (12 Fence Styles)
...
### Glass Pool Fencing (5 styles)
Frameless Pool Fence, Channel Pool Fence, Flat Top Pool Fence, BARR Pool Fence, Blade Pool Fence

### Glass Balustrade (3 styles)
Frameless Balustrade, Channel Balustrade, Standoff Balustrade

### Aluminium & Steel Fencing (4 styles)
BARR Fencing 1800, Blade Fencing 1800, Zeus Steel Fencing, Zeus Aluminium Fencing
...
- `Master Hinge Panels`
- `Master Gate Panels`
- `Soft Close Hinge Panels`
- `Soft Close Gates`
- `Raked Panels`
- `Gate Hinges Master`
- `Gate Hinges Soft Close`
- `Glass Gate Latches`
...
- `Glass Panels 12mm 970`
- `Glass Panels 15mm 1000`
- `Spigots 12mm`
- `Spigots 15mm`
- `Handrail 25x21`
- `Handrail 35 Series`
...
### Aluminium & Steel Fencing Styles
...
**12. Zeus Aluminium Fencing**
- `Zeus Aluminium Panels`
- `Zeus Aluminium Posts`
- `Zeus Aluminium Gates`
- `Zeus Aluminium Shrouds`
- `Zeus Hinges`
- `Zeus Latches`
- `Zeus Accessories`
...
- **Categories** are case-sensitive - use exact capitalization as shown above
- **Subcategories** are also case-sensitive - use exact names from the fence style lists
- The `active` column: use `1` for active products, `0` for inactive
- You can leave `subcategory` blank if not applicable
- Each fence style has specific subcategories - refer to the "Fence Styles with Available Subcategories" section above
- When importing via CSV, ensure category and subcategory combinations are valid (e.g., "Glass Panels" is valid for "Frameless Pool Fence" but not for "Zeus Steel Fencing")

## Total Count Summary

- **12 Fence Styles (Categories)**
- **90+ Subcategory Options** across all fence styles
- Each fence style has 6-12 specific subcategories available
