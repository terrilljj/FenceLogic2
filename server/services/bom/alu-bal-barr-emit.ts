...
export function emitAluBalBarrSpan(design: DesignLike, span: SpanLike, unmapped: string[]): BomLine[] {
  ...
  const code = (fieldOf(span, "balBarrFinish", "bal-finish", "barrFinish") || "black").startsWith("pearl") || fieldOf(span, "balBarrFinish") === "white" ? "W" : "B";
